...
class MainForm(QMainWindow, Ui_MainWindow):
    ...
    def T1_minus_T2(self):
        ...
        rs = dt.datetime.combine(date.today(), first_Time) - dt.datetime.combine(
            date.today(), second_Time
        )
    ...
    def T2_minus_T1(self):
        ...
        rs = dt.datetime.combine(date.today(), second_Time) - dt.datetime.combine(
            date.today(), first_Time
        )
        rs = time.gmtime(abs(rs.total_seconds()))
        hours = rs.tm_hour
        minutes = rs.tm_min
